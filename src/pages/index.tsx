      ...
      <div className='flex flex-col gap-4'>
        <div className='mt-2 flex  gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <p className=' rounded bg-white p-2'>
              Наш проект - это онлайн-магазин, который предоставляет
              пользователю возможность легко найти и заказать товары онлайн. У
              нас есть удобная функция фильтрации товаров и простой поиск, чтобы
              помочь пользователю найти нужные товары.
            </p>
            <p className=' rounded bg-white p-2'>
